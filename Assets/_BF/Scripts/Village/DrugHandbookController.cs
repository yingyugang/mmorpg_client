...
public class DrugHandbookController : MonoBehaviour {
	...
	void Start () {
		...
		bgReturn = UI.PanelStack.me.FindPanel ("Scale/NewVillage/CollectionHouse/PanelHandbook/PanelDrug/Above/bgReturn");
