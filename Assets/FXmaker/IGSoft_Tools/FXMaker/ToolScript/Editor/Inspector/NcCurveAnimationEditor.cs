...
// 			FxmInfoIndexing.FindInstanceIndexing(m_Sel.transform, false).GetComponent<NcCurveAnimation>().ResumeAnimation();
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_Sel.m_ResetOnEnable = EditorGUILayout.Toggle(GetHelpContent("m_ResetOnEnable"),m_Sel.m_ResetOnEnable);
			m_Sel.IsIgnreTimeScale = EditorGUILayout.Toggle(GetHelpContent("IsIgnreTimeScale"),m_Sel.IsIgnreTimeScale);
