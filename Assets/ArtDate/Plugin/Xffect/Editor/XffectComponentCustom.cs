...
public class XffectComponentCustom : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		DrawInfos();
		EditorGUILayout.BeginHorizontal ();
		EditorGUILayout.LabelField ("Custom Layer",GUILayout.Width(100));
		Script.customLayer =  EditorGUILayout.Toggle (Script.customLayer);
		EditorGUILayout.EndHorizontal ();
		if(Script.customLayer)
		{
			EditorGUILayout.BeginHorizontal ();
			...
			Script.LayerName = sortingLayerNames[popupMenuIndex];
			EditorGUILayout.LabelField ("Sorting Order",GUILayout.Width(100));
			Script.OrderLayer = EditorGUILayout.IntField (Script.OrderLayer);
			EditorGUILayout.EndHorizontal ();
		}
		serializedObject.ApplyModifiedProperties();
	}
