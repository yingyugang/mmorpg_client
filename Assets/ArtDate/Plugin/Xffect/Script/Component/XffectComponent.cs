...
namespace Xft
{
    ...
    public class XffectComponent : MonoBehaviour
    {
		...
		public string LayerName = "SuperLayer";
        ...
        MeshFilter CreateMeshObj(Material mat)
        {
            ...
            SetActive(obj, true);
			//TODO YingYuGang
			if(obj.GetComponent<Renderer>()!=null && customLayer)
			{
//				Debug.Log(obj.name);
				obj.AddComponent<Puppet2D_SortingLayer>();
				obj.GetComponent<Renderer>().sortingLayerName = LayerName;
				obj.GetComponent<Renderer>().sortingOrder = OrderLayer;
			}
