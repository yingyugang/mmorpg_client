...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Albedo = lerp(o.Albedo,_DepthColorG.rgb,texflow.r);
	o.Albedo = lerp(o.Albedo,_DepthColorR.rgb,texflow.g);
	//o.Albedo = lerp(o.Albedo,_DepthColor.rgb,_DepthColor.a);

	o.Alpha = _DepthColorB.a;
	o.Alpha = lerp(o.Alpha,_DepthColorG.a,texflow.r);
	o.Alpha = lerp(o.Alpha,_DepthColorR.a,texflow.g);
	//o.Alpha = lerp(o.Alpha,_DepthColor.rgb,_DepthColor.a);
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Albedo = _DepthColor.rgb;//lerp(_DepthColor.rgb,half3(0,0,0),waveTex.b);//getflowmap.rgb*2.0*waveTex.b;
	//o.Alpha += waveTex.b*getflowmap.r;//(getflowmap.g + getflowmap.r);
	o.Alpha = _DepthColor.a;
