...
CGPROGRAM
#pragma target 5.0
#pragma surface surf Lambert vertex:disp tessellate:tessDistance nolightmap Unlit noambient
...
#pragma surface surf Lambert vertex:disp tessellate:tessDistance nolightmap noambient
#include "Tessellation.cginc"
...
CGPROGRAM
#pragma target 5.0
#pragma surface surf BlinnPhong vertex:disp tessellate:tessDistance nolightmap noambient
#include "Tessellation.cginc"
#include <UnityCG.cginc>
//#pragma glsl
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	cubeRef = lerp(half3(0,0,0),cubeRef*2.5*_DynReflColor.a,mask);
	...
	//o.Albedo = lerp(_UnderColor.rgb*2.0,o.Albedo,0.25+lerp(0.0,3.0,texwave.r));
...
Pass{
	...
	sampler2D _CameraDepthTexture;
	float _RefrSpeed, _RefrStrength,_AnimSpeed,_RefrScale;
