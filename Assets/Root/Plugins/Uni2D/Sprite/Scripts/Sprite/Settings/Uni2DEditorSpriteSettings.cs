...
public class Uni2DEditorSpriteSettings
{
	...
	public SpriteRenderMesh renderMesh = SpriteRenderMesh.TextureToMesh;	// Non-interactive parameter
	...
	public float renderMeshAlphaCutOff            = 0.5f;
	public float renderMeshPolygonizationAccuracy = 3.0f;
